...
---
# Frontend Architecture, Backend Architecture, or Just Architecture?

> Challenges the traditional separation of "frontend" and "backend" architecture as distinct disciplines.
...
## Links
- [Source](https://www.architecture-weekly.com/p/frontent-architecture-backend-architecture) — original post
