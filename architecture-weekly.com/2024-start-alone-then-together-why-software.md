...
> Identifies the "CTO effect" where senior voices dominate software modeling sessions, suppressing junior perspectives.
...
## Links
- [Source](https://www.architecture-weekly.com/p/start-alone-then-together-why-software) — original post
