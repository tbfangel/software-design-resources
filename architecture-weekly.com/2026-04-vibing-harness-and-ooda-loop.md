...
> Oskar Dudycz argues that rapid LLM-assisted prototyping creates an illusion of progress by accelerating the "Act" phase of the OODA loop while quietly skipping the "Observe" and "Orient" steps.
...
## Links
- [Source](https://www.architecture-weekly.com/p/vibing-harness-and-ooda-loop) — original post
