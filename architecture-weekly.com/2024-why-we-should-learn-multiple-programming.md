...
> Senior developers should maintain flexibility across programming languages, not necessarily become experts in all of them.
...
## Links
- [Source](https://www.architecture-weekly.com/p/why-we-should-learn-multiple-programming) — original post
