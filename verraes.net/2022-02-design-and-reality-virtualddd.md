...
> Presentation from VirtualDDD where Verraes discusses the core thesis: modelling as the opportunity to create novel concepts.
...
## Links
- [Source](https://verraes.net/2022/02/design-and-reality-virtualddd/) — original post
