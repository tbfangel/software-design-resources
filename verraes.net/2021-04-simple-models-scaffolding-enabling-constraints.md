...
> When building complex domains, start with simple models that organize thinking without premature optimization or over-engineering.
...
## Links
- [Source](https://verraes.net/2021/04/simple-models-scaffolding-enabling-constraints/) — original post
