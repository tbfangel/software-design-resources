...
> This foundational essay challenges the fallacy that domain modelling is a linear process: understand the problem, apply design, deliver solution.
...
## Links
- [Source](https://verraes.net/2021/09/design-and-reality/) — original post
