...
> Ronacher argues that truly self-hosted open source requires standardised protocols (like CGI, SQL, and Linux formed the LAMP stack).
...
## Links
- [Source](https://lucumr.pocoo.org/2024/6/26/what-is-self-hosted/) — original post
