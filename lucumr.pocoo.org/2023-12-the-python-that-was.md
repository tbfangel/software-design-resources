...
> Ronacher argues that Python's shift toward static typing represents a departure from the language's original philosophy and strengths.
...
## Links
- [Source](https://lucumr.pocoo.org/2023/12/1/the-python-that-was/) — original post
