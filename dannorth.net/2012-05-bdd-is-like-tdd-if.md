...
> North clarifies the relationship between BDD and TDD, arguing they appear identical in programming-only teams but diverge significantly when non-programmers join.
...
## Links
- [Source](https://dannorth.net/blog/bdd-is-like-tdd-if/) — original post
