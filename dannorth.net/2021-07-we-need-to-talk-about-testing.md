...
> North argues that testing's fundamental purpose is to increase stakeholder confidence through evidence, not merely to validate code functionality.
...
## Links
- [Source](https://dannorth.net/blog/we-need-to-talk-about-testing/) — original post
