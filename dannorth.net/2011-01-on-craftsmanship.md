...
> North responds to feedback on his "Programming is not a craft" post, refining his argument that programming should be understood primarily as a trade rather than a craft, though it contains elements of both.
...
## Links
- [Source](https://dannorth.net/blog/on-craftsmanship/) — original post

## Related
- [Cluster synthesis](/dannorth.net/_synthesis-productivity-metrics.md)
- [McKinsey Developer Productivity Review](/dannorth.net/2023-10-mckinsey-review.md)
